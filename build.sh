...
build_single() {
    ...
    local build_cmd="$env_vars go build -trimpath -tags \"with_gvisor\" -ldflags=\"-s -w -X 'github.com/metacubex/mihomo/constant.Version=$VERSION' -X 'github.com/metacubex/mihomo/constant.BuildTime=$BUILD_TIME'\" -o '${OUTPUT_DIR}/${output_name}' ."
